...
contributor. This CLA is for your protection as a Contributor as well as for
the protection of Happy Technologies and its users.

## Terms

You accept and agree to the following terms and conditions for Your present and
future Contributions submitted to Happy Technologies.
...
2. **Grant of Copyright License.** Subject to the terms and conditions of this
   Agreement, You hereby grant to Happy Technologies and to recipients of
   software distributed by Happy Technologies a perpetual, worldwide,
...
4. **Representations.** You represent that You are legally entitled to grant the
   above licenses. You represent that each of Your Contributions is Your original
   creation. You are not expected to provide support for Your Contributions.

5. **No Warranty.** Your Contributions are provided "AS IS" WITHOUT WARRANTY OF
   ANY KIND, express or implied.

## How to Sign

The CLA is signed electronically via the CLA Assistant bot when you open your
first pull request. No paper forms required.
