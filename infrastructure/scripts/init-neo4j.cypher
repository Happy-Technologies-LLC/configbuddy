...
MERGE (u:User {email: 'admin@happyconfig.local'})
...
SET s1.name = 'web-prod-01.happyconfig.local',
    s1.type = 'server',
    s1.status = 'active',
...
SET s2.name = 'web-prod-02.happyconfig.local',
    s2.type = 'server',
    s2.status = 'active',
...
SET s3.name = 'api-prod-01.happyconfig.local',
    s3.type = 'server',
    s3.status = 'active',
...
SET s4.name = 'db-prod-01.happyconfig.local',
    s4.type = 'server',
    s4.status = 'active',
...
SET s5.name = 'win-prod-01.happyconfig.local',
    s5.type = 'server',
    s5.status = 'active',
...
SET s6.name = 'web-stg-01.happyconfig.local',
    s6.type = 'server',
    s6.status = 'active',
...
SET s7.name = 'api-stg-01.happyconfig.local',
    s7.type = 'server',
    s7.status = 'active',
...
SET s8.name = 'web-dev-01.happyconfig.local',
    s8.type = 'server',
    s8.status = 'active',
...
SET s9.name = 'backup-maint-01.happyconfig.local',
    s9.type = 'server',
...
SET s10.name = 'old-web-decom-01.happyconfig.local',
    s10.type = 'server',
...
SET a1.name = 'HappyConfig Web Frontend',
    a1.type = 'application',
    a1.status = 'active',
    ...
    a1.metadata = '{
      ...
      "repository": "github.com/happyconfig/web-ui",
      "deployment_method": "docker",
      "tags": ["frontend", "react", "typescript"]
    }';

MERGE (a2:CI:Application {id: 'app-api-backend'})
SET a2.name = 'HappyConfig API Server',
    a2.type = 'application',
    a2.status = 'active',
    ...
    a2.metadata = '{
      ...
      "repository": "github.com/happyconfig/api-server",
      "deployment_method": "docker",
...
SET a3.name = 'Discovery Engine',
    ...
    a3.metadata = '{
      ...
      "language": "TypeScript",
      "repository": "github.com/happyconfig/discovery-engine",
      "deployment_method": "docker",
...
SET a4.name = 'ETL Processor',
    ...
    a4.metadata = '{
      ...
      "framework": "BullMQ Worker",
      "language": "TypeScript",
      "repository": "github.com/happyconfig/etl-processor",
      "deployment_method": "docker",
...
SET a5.name = 'Monitoring Agent',
    ...
    a5.metadata = '{
      "version": "1.0.5",
      "language": "Go",
      "repository": "github.com/happyconfig/agent",
...
SET net1.name = 'Production Load Balancer',
    ...
    net1.metadata = '{
      ...
      "provider": "AWS ELB",
      "public_dns": "lb-prod-01.happyconfig.com",
...
SET st1.name = 'S3 Backup Bucket',
    ...
    st1.external_id = 's3://happyconfig-backups-prod',
    ...
    st1.metadata = '{
      ...
      "provider": "AWS S3",
      "bucket_name": "happyconfig-backups-prod",
      "size_gb": 2500,
      "versioning": true,
      "encryption": "AES-256",
