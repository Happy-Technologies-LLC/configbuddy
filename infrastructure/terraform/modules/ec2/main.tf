...
resource "aws_security_group" "instances" {
  name_prefix = "happyconfig-${var.name_prefix}-${var.environment}-"
  ...
  tags = {
    Name        = "happyconfig-${var.name_prefix}-sg-${var.environment}"
...
resource "aws_iam_role" "instances" {
  ...
  tags = {
    Name        = "happyconfig-${var.name_prefix}-role-${var.environment}"
    Environment = var.environment
  }
}
...
resource "aws_instance" "instances" {
  ...
  tags = {
    Name        = "happyconfig-${var.name_prefix}-${count.index + 1}-${var.environment}"
    Environment = var.environment
